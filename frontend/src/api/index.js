...
export const stList = () => http.get('/market/st/list').then(unwrap)
export const adminStAdd = (code) => http.post('/market/st/add', { code }).then(unwrap)
export const adminStDelete = (code) => http.delete(`/market/st/${encodeURIComponent(code)}`).then(unwrap)
